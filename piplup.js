...
var grammar = {
    ...
    {"name": "statement", "symbols": ["const_assign"], "postprocess": id},
    {"name": "statement", "symbols": ["import"], "postprocess": id},
    {"name": "statement", "symbols": [(lexer.has("mulitlineComment") ? {type: "mulitlineComment"} : mulitlineComment)], "postprocess": id},
    {"name": "var_assign", "symbols": [{"literal":"piplup"}, "_", (lexer.has("identifier") ? {type: "identifier"} : identifier), "_", {"literal":"="}, "_", "expr"], "postprocess": 
        (data) => {
            return {
                type: "var_assign",
                var_name: data[2],
    ...
    {"name": "import", "symbols": [{"literal":"import"}, "_", (lexer.has("identifier") ? {type: "identifier"} : identifier), "_", {"literal":"="}, "_", "expr"], "postprocess": 
        (data) => {
            return {
                type: "import",
                import_name: data[2],
    ...
    {"name": "const_assign", "symbols": [{"literal":"pip"}, "_", (lexer.has("identifier") ? {type: "identifier"} : identifier), "_", {"literal":"="}, "_", "expr"], "postprocess": 
        (data) => {
            return {
                type: "const_assign",
                const_name: data[2],
    ...
    {"name": "function$ebnf$1$subexpression$1", "symbols": ["param_list", "_"]},
    ...
    {"name": "function", "symbols": [{"literal":"def"}, "__", (lexer.has("identifier") ? {type: "identifier"} : identifier), "_", {"literal":"("}, "function$ebnf$1", {"literal":")"}, "_ml", "lambda_body"], "postprocess": 
        (data) => {
            return {
                type: "function",
                func_name: data[2],
    ...
    {"name": "param_list$ebnf$1$subexpression$1", "symbols": ["__", {"literal":"pip"}, "__", (lexer.has("identifier") ? {type: "identifier"} : identifier)]},
